...
public class Application {
    private static final String DINNER_PATH = "C:\\Users\\Alerix\\University\\cpp\\src\\main\\resources\\dinner";
    private static final String MENU_PATH = "C:\\Users\\Alerix\\University\\cpp\\src\\main\\resources\\pizza";
    ...
    public static void run(Boolean isJson) {
        ...
        switch (choise) {
            case 1 -> {
                ...
                TerminalOutput.print(processor.getDinnerList(), "Dinners:\n");
            }
            ...
            case 6 -> TerminalOutput.print(processor.getGroupByPizzaMap(), "Dinners grouped by pizza:\n");
            case 7 -> TerminalOutput.print(processor.getExpiresDinnersMap(), "Expired dinners:\n");
            case 8 -> {
